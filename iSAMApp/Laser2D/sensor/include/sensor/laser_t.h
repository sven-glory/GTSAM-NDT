...
/**
 * Create a deep copy of a laser_t.
 * When no longer needed, destroy it with laser_t_destroy()
 */
laser_t* laser_t_copy(const laser_t* to_copy);

/**
 * Destroy an instance of laser_t created by laser_t_copy()
 */
void laser_t_destroy(laser_t* to_destroy);
 ...
 * laser_t is received.
 */
typedef void(*laser_t_handler_t)(
    const lcm_recv_buf_t *rbuf, const char *channel,
    const laser_t *msg, void *userdata);

/**
 * Publish a message of type laser_t using LCM.
 *
 ...
 */
int laser_t_publish(lcm_t *lcm, const char *channel, const laser_t *msg);

/**
 * Subscribe to messages of type laser_t using LCM.
 *
 ...
 */
laser_t_subscription_t* laser_t_subscribe(
    lcm_t *lcm, const char *channel, laser_t_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by laser_t_subscribe()
 */
 ...
 * @return 0 on success, <0 if an error occured
 */
int laser_t_subscription_set_queue_capacity(
    laser_t_subscription_t* subs, int num_messages);

/**
 * Encode a message of type laser_t into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to laser_t_encoded_size().
...
/**
 * Decode a message of type laser_t from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with laser_t_decode_cleanup().
 *
 ...
 */
int laser_t_decode(const void *buf, int offset, int maxlen, laser_t *msg);

/**
 * Release resources allocated by laser_t_decode()
 * @return 0
 */
int laser_t_decode_cleanup(laser_t *p);

/**
 * Check how many bytes are required to encode a message of type laser_t
 */
int laser_t_encoded_size(const laser_t *p);

// LCM support functions. Users should not call these
int64_t __laser_t_get_hash(void);
uint64_t __laser_t_hash_recursive(const __lcm_hash_ptr *p);
int __laser_t_encode_array(
    void *buf, int offset, int maxlen, const laser_t *p, int elements);
int __laser_t_decode_array(
    const void *buf, int offset, int maxlen, laser_t *p, int elements);
