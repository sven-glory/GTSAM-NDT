...
//
CScp::CScp(CPoint2d& ptStart, CPoint2d& ptEnd, CAngle& angLane)
{
	...
	CPoint2d ptLocalEnd = m_Transform.GetLocalPoint(m_ptEnd);
...
//
BOOL CScp::FindRefX(CPoint2d& pt, float& fRefX, float& fErrX)
{
	CPoint2d ptLocal = m_Transform.GetLocalPoint(pt);
...
//
BOOL CScp::FindErrY(CPoint2d& pt, float& fErrY)
{
	CPoint2d pt1 = m_Transform.GetLocalPoint(pt);
